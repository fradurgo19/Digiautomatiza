          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/p/Digiautomatiza-Innovaci%C3%B3n-Digital-61583996005929" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full backdrop-blur-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-500/20 hover:border-emerald-500/40 transition-all" aria-label="Facebook Digiautomatiza">
                ...
                <a href="https://www.linkedin.com/company/automatizaci%C3%B3nconpowerplatform/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full backdrop-blur-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-emerald-500/20 hover:border-emerald-500/40 transition-all" aria-label="LinkedIn Digiautomatiza">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="tel:+573133683567" className="hover:text-emerald-400 transition-colors">
                    +57 313 368 3567
                  </a>
                </li>
              </ul>
